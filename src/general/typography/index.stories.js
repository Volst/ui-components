            ...
            return (
                <div>
                    ...
                    <Text>
                        ...
                        Etiam est ex, blandit at felis sit amet, egestas
                        tincidunt metus. Phasellus aliquet blandit scelerisque.
                        Nullam congue vehicula condimentum. Proin pulvinar
                        pellentesque pharetra. Morbi imperdiet ante eget nibh
                        venenatis, sed volutpat lectus facilisis. Nulla nec
                        nulla vel orci volutpat consectetur. Praesent porta,
                        quam in aliquam ornare, ex metus vehicula nisi, a
                        posuere est sapien sit amet neque. Maecenas at malesuada
                        lorem. Etiam placerat felis ac tortor laoreet, at
                        molestie ipsum blandit.
                    </Text>
                    <Subheading>A subheading</Subheading>
                    <Text>
                        Nam consequat viverra molestie. Nulla in lorem nulla. Ut
                        sagittis nunc sit amet magna eleifend posuere.
                        Vestibulum non elit sed lacus tristique rhoncus. Donec
                        consectetur tempus tellus, id aliquet tortor luctus sed.
                        In cursus vitae urna quis viverra. Donec non egestas
                        eros. Quisque eget arcu in risus venenatis iaculis id
                        sit amet nibh. Vivamus mi nibh, lobortis eget maximus
                        quis, molestie non lorem. In ac facilisis odio. Aenean
                        tincidunt scelerisque leo in elementum. Curabitur
                        consequat dui vel augue laoreet, id fermentum ipsum
                        semper. Pellentesque ut turpis sed leo pharetra euismod
        ...
        withInfo()(() => {
            return (
                <div>
                    ...
                    <Text small>
                        A paragraph written in smaller text than normal.
                    </Text>
                </div>
            );
        })
